...
const CATALOG = [
  ...
  },
  {
    ...
    sortOrder: 15,
    services: [
      { name: "Basic Exterior Wash",                    unit: "vehicle", sortOrder: 1, override_low:   75, override_high:  125 },
      { name: "Full Interior Detail",                   unit: "vehicle", sortOrder: 2, override_low:   95, override_high:  165 },
      { name: "Full Interior & Exterior Detail",        unit: "vehicle", sortOrder: 3, override_low:  175, override_high:  325 },
      { name: "Premium Detail (clay bar + sealant)",    unit: "vehicle", sortOrder: 4, override_low:  325, override_high:  595 },
      { name: "SUV / Truck Upcharge",                   unit: "vehicle", sortOrder: 5, override_low:   25, override_high:   65 },
      { name: "Odor Treatment",                         unit: "vehicle", sortOrder: 6, override_low:   75, override_high:  145 },
      { name: "Engine Bay Cleaning",                    unit: "vehicle", sortOrder: 7, override_low:   65, override_high:  115 },
      { name: "Ceramic Coating Prep",                   unit: "vehicle", sortOrder: 8, override_low:  150, override_high:  350 },
    ],
  },
  {
    ...
    sortOrder: 16,
    services: [
      { name: "Standard Clean — Small (under 1,500 sq ft)",   unit: "visit",   sortOrder: 1, override_low: 110, override_high: 165 },
      { name: "Standard Clean — Medium (1,500–2,500 sq ft)",  unit: "visit",   sortOrder: 2, override_low: 145, override_high: 220 },
      { name: "Standard Clean — Large (2,500–4,000 sq ft)",   unit: "visit",   sortOrder: 3, override_low: 195, override_high: 295 },
      { name: "Deep Clean Add-On",                            unit: "sq ft",   sortOrder: 4, override_low: 0.08, override_high: 0.15 },
      { name: "Move-In / Move-Out Clean",                     unit: "project", sortOrder: 5, override_low: 250, override_high: 500 },
      { name: "Interior Window Cleaning",                     unit: "window",  sortOrder: 6, override_low:   5, override_high:  12 },
      { name: "Laundry Service",                              unit: "load",    sortOrder: 7, override_low:  25, override_high:  40 },
      { name: "Inside Refrigerator Clean",                    unit: "each",    sortOrder: 8, override_low:  45, override_high:  75 },
      { name: "Inside Oven Clean",                            unit: "each",    sortOrder: 9, override_low:  45, override_high:  75 },
    ],
  },
  {
    name: "Poop Scooping",
    ...
    sortOrder: 17,
    services: [
      { name: "Weekly Service — 1 Dog",        unit: "month", sortOrder: 1, override_low:  65, override_high:  90 },
      { name: "Weekly Service — 2–3 Dogs",     unit: "month", sortOrder: 2, override_low:  85, override_high: 125 },
      { name: "Weekly Service — 4+ Dogs",      unit: "month", sortOrder: 3, override_low: 110, override_high: 165 },
      { name: "Bi-Weekly Service — 1 Dog",     unit: "month", sortOrder: 4, override_low:  40, override_high:  60 },
      { name: "Bi-Weekly Service — 2–3 Dogs",  unit: "month", sortOrder: 5, override_low:  55, override_high:  85 },
      { name: "One-Time Yard Clean-Up",        unit: "visit", sortOrder: 6, override_low:  65, override_high: 145 },
    ],
  },
  {
    ...
    sortOrder: 18,
    services: [
      { name: "Weekly Property Check",         unit: "month", sortOrder: 1, override_low: 125, override_high: 225 },
      { name: "Bi-Weekly Property Check",      unit: "month", sortOrder: 2, override_low:  85, override_high: 145 },
      { name: "Monthly Property Check",        unit: "month", sortOrder: 3, override_low:  55, override_high:  95 },
      { name: "Single Walkthrough Visit",      unit: "visit", sortOrder: 4, override_low:  75, override_high: 125 },
      { name: "Pre / Post-Vacation Check",     unit: "visit", sortOrder: 5, override_low:  65, override_high: 115 },
      { name: "Storm Damage Assessment",       unit: "visit", sortOrder: 6, override_low:  85, override_high: 175 },
    ],
  },
  {
    ...
    sortOrder: 19,
    services: [
      { name: "Per Hour (local errands)",           unit: "hour",       sortOrder: 1, override_low:  38, override_high:  55 },
      { name: "Grocery Shopping & Delivery",        unit: "trip",       sortOrder: 2, override_low:  45, override_high:  75 },
      { name: "Prescription Pickup",                unit: "trip",       sortOrder: 3, override_low:  28, override_high:  45 },
      { name: "Post Office / Shipping Run",         unit: "trip",       sortOrder: 4, override_low:  28, override_high:  45 },
      { name: "Return / Exchange Run",              unit: "trip",       sortOrder: 5, override_low:  32, override_high:  55 },
      { name: "Dry Cleaning Drop-Off & Pickup",     unit: "round trip", sortOrder: 6, override_low:  35, override_high:  55 },
      { name: "Monthly Errand Package (4 hrs/mo)",  unit: "month",      sortOrder: 7, override_low: 125, override_high: 195 },
    ],
  },
] as const;
